...
export const _root_container = styled(_container)`
...
`;
export const _container_center = styled(_container)`
  display: flex;
...
`;
export const _nft_container = styled(_container_center)`
  > div > div {
    margin: 0;
  }
  transform: scale(0.9);
...
export const _resource_gain = styled(_container_center)`
  margin-top: 8px;
  margin-bottom: 8px;
  flex-direction: row;
  ...
  gap: 1em;
`;
export const _resource = styled(_container_center)`
  flex-direction: row;
  gap: 0.2em;
  > span {
...
export const _subtitle_container = styled(_container)`
  margin-top: 8px;
  margin-bottom: 8px;
  display: flex;
  flex-direction: row;
