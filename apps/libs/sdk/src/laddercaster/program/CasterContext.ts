...
export class CasterContext {
  ...
  async prestigeCaster() {
    ...
    try {
      console.log(
        'old season',
        await gameConstantsContext.Client.program.account.season.fetch(
          gameConstantsContext.previousSeason,
        ),
      );
    } catch (e) {
      console.log(e);
  ...
  > {
    return gameConstantsContext.getCasterAccounts;
  }
}
